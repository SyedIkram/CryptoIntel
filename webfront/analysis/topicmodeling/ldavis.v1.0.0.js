...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    var K, // number of topics
        ...
        color1 = "#0000ff", // baseline color for default topic circles and overall term frequencies
        color2 = "#ff0000"; // 'highlight' color for selected topics and term-topic frequencies
    ...
    function visualize(data) {
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicLabel.setAttribute("style", "font-size: 20px");
            topicLabel.innerHTML = "Selected Topic: <span id='" + topicID + "-value'></span>";
            topicDiv.appendChild(topicLabel);

            var topicInput = document.createElement("input");
            topicInput.className = "col-form-label input-rounded";
            topicInput.setAttribute("style", "width: 50px; height: 40px;padding:7px !important;margin:0px !important;");
            ...
            previous.className = "btn btn-outline-primary mb-3";
            ...
            next.className = "btn btn-outline-primary mb-3";
            ...
            clear.className = "btn btn-outline-primary mb-3";
            ...
            lambdaDiv.className = "rcorners3" ;
            lambdaDiv.setAttribute("id", lambdaInputID);
            lambdaDiv.setAttribute("style", "padding: 5px; display: inline-block; height: 50px; width: " + lambdaDivWidth + "px; float: right; margin-right: 30px");
            ...
            sliderDiv.setAttribute("style", "padding: 5px; height: 40px; width: 250px; float: right; margin-top: -5px; margin-right: 40px");
            ...
            lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: sans-serif; font-size: 14px; margin-left: 20px; margin-top: 10px");
